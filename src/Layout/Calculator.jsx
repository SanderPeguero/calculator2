...
const Calculadora = () => {
    ...
    const handleEqualsClick = () => {
        ...
        setinputNumber('')
        const resultFromEval = eval(inputNumber);
        setResult(resultFromEval)
        setHistory([...history, {expression: inputNumber, result: resultFromEval}])
    ...
    return (
        ...
        <div>
            <div className="min-w-screen min-h-screen bg-gray-100 flex items-center justify-center px-5 py-5">
                <div className="flex flex-row-reverse w-[40rem]">
                    {showHistory && <History history={history}  onClick={() => setShowHistory(!showHistory)}/>}
                    ...
                    <div className="w-full mx-auto rounded-xl bg-gray-100 shadow-xl text-gray-800 relative overflow-hidden" style={{ maxWidth: 300 }} >
                        ...
                        <div>
                            <div className="w-full h-40 bg-gradient-to-b from-gray-800 to-gray-700 flex items-end text-right">
                                <div className="mb-[8rem] mt-8 ml-2">
                                ...
                                <div className="w-full py-5 px-6 text-6xl text-white font-thin">
                                    ...
                                    {inputNumber !== "" ?
                                        (inputNumber.toString().includes('*') ? inputNumber.toString().replace(/\*/g, 'x') :
                                            (inputNumber.toString().includes('/') ? inputNumber.toString().replace(/\//g, '÷') : inputNumber))
